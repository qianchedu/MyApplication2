 ...
 */
package com.powerful.activity.core.upnp;

import android.util.Log;

import com.powerful.activity.core.server.JettyResourceServer;
import com.powerful.activity.database.MediaResourceDao;
    ...
    static class ContainerFactory {
        ...
        static Container createContainer(String containerId, String serverUrl) {
            ...
            if (ROOT.equals(containerId)) {
                ...
                Log.d("AUDIO_CLASS", "createContainer: " + AUDIO_CLASS);
