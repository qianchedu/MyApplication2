 ...
 */
package com.powerful.activity.service;

import android.content.Intent;
import android.os.IBinder;
import android.util.Log;

import com.powerful.activity.core.upnp.AndroidJettyServletContainer;
import com.powerful.activity.core.upnp.BeyondContentDirectoryService;
import com.powerful.activity.util.Utils;
...
public class BeyondUpnpService extends AndroidUpnpServiceImpl {
    ...
    protected UpnpServiceConfiguration createConfiguration() {
        Log.d(TAG, "createConfiguration:hehe  " );
        return new FixedAndroidUpnpServiceConfiguration();
    }

    @Override
    public IBinder onBind(Intent intent) {
        Log.d(TAG, "onBind: 不知都");
        return binder;
    }
